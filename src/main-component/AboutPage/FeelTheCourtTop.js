...
import FeelTheCourt from '../../components/about4/feelthecourt';

const FeelTheCourtTop= () => {
    return (
        <Fragment>
            <Navbar hclass={'header-style-1'} Logo={Logo} btnClass={'theme-btn-s1'} />
            <PageTitle pageTitle={'Feel The Court'} pagesub={'Feel the Court'} nomepagina={'feel-the-court'} />
            <FeelTheCourt/>
            <Footer />
            <Scrollbar />
        </Fragment>
...
export default FeelTheCourtTop;
